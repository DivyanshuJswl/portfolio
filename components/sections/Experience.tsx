...
export default function Experience() {
  ...
  return (
    <section
      id="experience"
      className="min-h-screen py-24 px-4 relative bg-transparent overflow-hidden"
    >
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="mb-6">
                        ...
                        <ul className="space-y-3">
                          {item.achievements.map((point, i) => (
                            <li
                              key={i}
                              className="flex items-start gap-3 text-slate-600 dark:text-slate-400 text-sm md:text-base"
                            >
                              <span className="text-teal-500 mt-1.5 font-bold">
                                ▹
                              </span>
                              {point}
                            </li>
                      ...
                      <div className="flex flex-wrap gap-2 pt-6 border-t border-slate-200/50 dark:border-white/5">
                        {item.tech.map((t) => (
                          <span
                            key={t}
                            className="px-3 py-1 text-xs font-semibold rounded-lg bg-indigo-50 dark:bg-indigo-500/10 text-indigo-700 dark:text-indigo-300 border border-indigo-100 dark:border-indigo-500/20"
                          >
                            {t}
                          </span>
                        ))}
